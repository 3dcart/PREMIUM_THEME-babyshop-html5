function resizeMainContent() {
    ...
    if($('#home').length>0){
        $(mainContent).addClass('col-md-12').removeClass('col-md-9');
        $(leftSidebar).addClass('col-md-12').removeClass('col-md-3');
    }
...
jQuery(document).ready(function($) { 
    ...
    var var_1 = $('.header-specials');
    var var_2 = $('.productBlockContainer');
    var var_4 = $('.group-img');
    $('.left-col').append(var_1);
    $('.left-col').append(var_2);
    $('.left-col').append(var_4);

    var var_3 = $('#leftBar');
    $('.right-col').append(var_3);
...
$(document).ready(function(){
   ...
   // block_contact();
    ...
    //      else
    //      {
    //       $(this).parent().siblings('.open-sub').find('.footer-link').next().slideUp('fast');
    //       $(this).parent().siblings().removeClass('open-sub');
    //       $(this).parent().find('.footer-link').next().slideDown('fast',function (){
    //       });
...
function toggleMobileMenu()
{
    $('.footer-link').click(function(e) {
        ...
        { 
            e.preventDefault;
            //console.log('test');
            var parent_e = $(this).parents('.modLinks');
            //$(this).parent('.block-instagram').toggleClass('open');
            if(parent_e.hasClass('active-menu'))
            {
                parent_e.find('.frame-links').slideUp();
                parent_e.removeClass('active-menu');
            }
            else
            {
                $('.modLinks.active-menu').find('.frame-links').slideUp();
                $('.modLinks').removeClass('active-menu');
                parent_e.find('.frame-links').slideDown();
                parent_e.addClass('active-menu');
            }
        }
    })
}
